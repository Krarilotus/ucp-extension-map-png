--- mappng/ui/icons.lua
---
--- Loads isolated 52x22 glyphs from the creator's transparent originals. TGX
...
M.ICON_FILES = {
  import_heightmap = "ucp/modules/map-png/resources/icons/isolated/import_heightmap.png",
